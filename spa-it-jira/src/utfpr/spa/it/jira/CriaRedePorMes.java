...
public class CriaRedePorMes {
	...
	public void buildEdges() throws Exception{				
		for (Issue issue : issues) {
			...
			for (Comment comment : comments) {
				if((comment.getCreationDate().after(startDate))&&(comment.getCreationDate().before(endDate))){
					Edge edgeE = new Edge();
	...
	public void geraArquivoGml() throws IOException, ParseException{
		//File arquivo = new File("C:/Users/AnaaMaciel/Documents/UTFPR/TCC/JIRA/RedesPorMes/redeCompletaEclipse_v1.gml");
		File arquivo = new File("C:/Users/AnaaMaciel/Documents/UTFPR/TCC/JIRA/RedesPorMes/Semestre/2012-02.gml");
	...
	public static void main(String[] args) throws Exception {
		CriaRedePorMes rede = new CriaRedePorMes();
		rede.obterDados();
		rede.buildNodes();
		rede.buildEdges();
		rede.geraArquivoGml();
