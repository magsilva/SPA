...
import utfpr.spa.it.ArquivoModificado;
import utfpr.spa.it.Comentario;
import utfpr.spa.it.Commits;
import utfpr.spa.it.Issue;
import utfpr.spa.it.Label;
import utfpr.spa.it.Projeto;
import utfpr.spa.it.TargetVersion;

/**
 *
 * @author Douglas
 */
public class HttpIssueMiner extends AbstractJiraMiner
{
     ...
     * @throws Exception
     */
    public void atualizarDatasDasIssuesDoProjeto(int numeroIssueInicial)
    {
    	JPA_DAO<Integer, Issue> dao = new JPA_DAO<Integer, Issue>(Integer.class, Issue.class);
     ...
     * @throws Exception
     */
    public void atualizarCommitsDasIssues() {
     ...
     * @throws Exception
     */
    public void atualizarCommitsDasIssues(int numeroIssueInicial)
    {
    	JPA_DAO<Integer, Issue> dao = new JPA_DAO<Integer, Issue>(Integer.class, Issue.class);
    	dao.setEntityManager(getEntityManager());
    ...
    private void lerPaginasHtmlsEAtualizarIssuesExistentes(List<String> linhasComentarios, List<String> linhasCommits)
    {
    	JPA_DAO<Integer, Issue> dao = new JPA_DAO<Integer, Issue>(Integer.class, Issue.class);
    	dao.setEntityManager(getEntityManager());
    	
        Issue issue = consultaIssuePorNumeroEProjeto(numeroProximaPagina, projeto);
    ...
    private void lerPaginasHtmlsESalvarNovasIssues(List<String> linhasComentarios, List<String> linhasCommits)
    {
