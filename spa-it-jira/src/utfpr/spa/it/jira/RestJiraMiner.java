...
public class RestJiraMiner
{
	...
	{
		HttpJob job = new HttpJob(HttpMethod.GET, new URI("https://issues.apache.org/jira/rest/api/2/search?jql=project=HADOOP+ORDER+BY+key+ASC&startAt=1&maxResults=30&fields=*all"));
