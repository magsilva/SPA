...
public class GraphToolkitExample
{
	public GraphToolkitExample(File filename)
	{
		...
		try {
		    ec.exportFile(new File("C:/Users/AnaaMaciel/Documents/UTFPR/TCC/REDESMES/GraphToolkit/Semestre/2012-02Label2.pdf"));
		} catch (Exception e) {
		    throw new IllegalArgumentException(e);
		}
	}
	...
	{
		GraphToolkitExample gte = new GraphToolkitExample(new File("C:/Users/AnaaMaciel/Documents/UTFPR/TCC/REDESMES/Semestre/2012-02.gml"));
	}
}
